        ...
        describe(ruleName, function() {
            if (!test.valid || test.valid.length < 1) {
                ...
                it("should have at least one valid test", function() {
                    assert.fail(test.valid ? test.valid.length : 0, 1, "Each rule should have at least one valid test");
                });
            } else {
            ...
            if (!test.invalid || test.invalid.length < 1) {
                ...
                it("should have at least one invalid test", function() {
                    assert.fail(test.invalid ? test.invalid.length : 0, 1, "Each rule should have at least one invalid test");
                });
            } else {
